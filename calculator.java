...
class calculator extends JFrame implements ActionListener {
    ...
    JButton addButton, subtractButton, multiplyButton, modulusButton, equalsButton, clearButton;
    ...
    calculator() {
        ...
        resultField = new JTextField(100);
        resultField.setPreferredSize(new Dimension(50 , 50));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (clickedButton == clearButton) {
            ...
            if (clickedButton == modulusButton) {
                operator = '%';
                isOperator = true;
            }
